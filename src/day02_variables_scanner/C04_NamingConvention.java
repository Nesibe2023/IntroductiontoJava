...
public class C04_NamingConvention {
    public static void main(String[] args) {
        ...
        /*
            ...
            variable ismi olarak byuk ya da kucuk harf yazmaniza java karismaz
            ancak naming convention soyledir

            variable isimleri kucuk harfle baslar ve devam eder
            ancak birden fazla kelime kullanilacaksa sonraki kelimelerin ilk harfleri buyuk harf olur

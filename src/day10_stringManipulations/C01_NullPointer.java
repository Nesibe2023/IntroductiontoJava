...
public class C01_NullPointer {
    public static void main(String[] args) {
        ...
        // null pointer : non primitive bir objenin olusuturuldugunu
        //                  ancak bilincli olarak deger atanmadigini isaretler
        //                  str4 degeri null`dir cumlesi YANLIS,
        ...
        java bir variable`i olustutp deger atamamasina ragmen izin verir
        ...
        nul pointer ise bu variable`a bir deger atanmadigini

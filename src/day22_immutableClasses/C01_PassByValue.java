...
public class C01_PassByValue {
    ...
    public static void main(String[] args) {
        ...
        // verilen bir list`te degisiklik yapan 2 method olusturun
        // 1.method list`in elementlerine yeni deger atayp yazdirsin
        //2.method list`e yeni bir list degeri atayip yeni list`e
        //elemntler ekleyip yazdirsin
    ...
    private static void elemanlariDegistir(List<Integer> sayilar) {
        ...
        System.out.println("elemanlari degistir methodund list : " + sayilar);   // [25, 54, 67]
    ...
    private static void yeniListAta(List<Integer> sayilar) {
        ...
        System.out.println("yeni list ata methodunda sayilar list`in son hali  : " + sayilar);  // [34, 98 , 11]
    }

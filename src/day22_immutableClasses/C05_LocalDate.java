...
public class C05_LocalDate {
    public static void main(String[] args) {
        ...
        System.out.println(tarih.getDayOfYear()); // 354
        ...
        System.out.println(tarih.minusYears(3).minusDays(5));  // 2019-12-15

        System.out.println(tarih.plusWeeks(19)); // 2023-05-02
        System.out.println(tarih.plusYears(10).plusMonths(3).plusDays(10)); // 2033-03-30
        ...
        System.out.println(tarih.hashCode());  // 414843

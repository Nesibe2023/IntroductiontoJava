...
public class C02_remove {
    public static void main(String[] args) {
        ...
        System.out.println(harfler.remove("Z")); // true Z `yi bulup siler ve gorevi tamamladigi icin
        System.out.println(harfler); // [A,T]

        System.out.println(harfler.remove(0)); // A
        // 0.indexteki elementi siler ve gorevi tamamlayip silinen elementi bize dondurur

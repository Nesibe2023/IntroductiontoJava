...
public class CAvciKuslar extends BKuslar {
    ...
    public static void main(String[] args) {
        ...
        krt1.gaga(); // c sivri gagalidir
        krt1.kanat(); // b sivri gagali
        krt1.solunum(); // b akcigerle nefes alirlar
        krt1.cogalma(); // b yumurta ile cogalirlar
        ...
        // krt2.pence(); // BKuslar parent class`da yok, CTE verir
        krt2.gaga(); // c sivri gagalidir
        krt2.kanat(); // b sivri gagali
        krt2.solunum(); // b akcigerle nefes alirlar
        krt2.cogalma(); // b yumurta ile cogalirlar
        ...
        krt3.cogalma(); // b yumurta ile cogalirlar
